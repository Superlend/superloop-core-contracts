...
contract WithdrawManagerTest is IntegrationBase {
    ...
    function test_resolveWithdrawRequestsWithPartials() public {
        ...
        (uint256 sharesLeftToResolve,,) = _createPartialWithdrawWithResolution();
    ...
    function test_resolveWithdrawRequestsWithCancellation() public {
        ...
        withdrawManager.cancelWithdrawRequest(1, DataTypes.WithdrawRequestType.GENERAL);
        vm.stopPrank();
        ...
        vm.startPrank(user2);
        withdrawManager.cancelWithdrawRequest(2, DataTypes.WithdrawRequestType.GENERAL);
        vm.stopPrank();
        ...
        assertTrue(withdrawRequest3.amountClaimable > 0);
        totalPendingWithdraws = withdrawManager.totalPendingWithdraws(DataTypes.WithdrawRequestType.GENERAL);
        ...
        withdrawManager.requestWithdraw(10 * ONE_SHARE, DataTypes.WithdrawRequestType.GENERAL);
        vm.stopPrank();
    ...
    function test_withdraw() public {
        ...
        vm.startPrank(user1);
        withdrawManager.withdraw(DataTypes.WithdrawRequestType.GENERAL);
        vm.stopPrank();
        ...
        vm.startPrank(user2);
        withdrawManager.cancelWithdrawRequest(2, DataTypes.WithdrawRequestType.GENERAL);
        withdrawRequest2 = withdrawManager.withdrawRequest(2, DataTypes.WithdrawRequestType.GENERAL);
        assertEq(uint256(withdrawRequest2.state), uint256(DataTypes.RequestProcessingState.PARTIALLY_CANCELLED));
        assertEq(withdrawRequest2.amountClaimable, 0);
