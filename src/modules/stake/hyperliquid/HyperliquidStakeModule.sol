...
contract HyperliquidStakeModule is Context {
    IOverseerV1 public immutable overseer;

    event HyperliquidStaked(uint256 assets, uint256 shares, address caller);
    ...
    function execute(DataTypes.StakeParams memory params) external onlyExecutionContext {
        ...
        emit HyperliquidStaked(params.assets, amountMinted, _msgSender());
    }
